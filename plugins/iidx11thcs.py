...
class Iidx11thCsHandler:
    ...
    def extract(exe_filename, input_folder, output_folder, raw_mode, conversion_mode):
        ...
        _, song_metadata = Iidx11thCsHandler.read_songlist(exe_filename, 0x1c21f0, 0x6f40 // 0x140, main_archive_file_entries, animation_file_entries)
        ...
        if 'song' in conversion_mode and not raw_mode:
            common.extract_songs(main_archive_file_entries, output_folder, '11thcs', song_metadata)
